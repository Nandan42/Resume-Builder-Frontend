...
export class Resume extends Component{
    ...
    handleSubmit = () => {
        axios.post('https://resume-builder-backend-nandan.herokuapp.com/create-pdf', this.state)
          .then(() => axios.get('https://resume-builder-backend-nandan.herokuapp.com/fetch-pdf', { responseType: 'blob' }))
          .then((res) => {
